...
The application is using a parallelized version of the LDA algorithm provided by the Gensim library for Python. More information on the Gensim implementation of the algorithm can be found from [Gensim documentation](https://radimrehurek.com/gensim/models/ldamulticore.html). The article [Hoffman, Blei, Bach: Online Learning for Latent Dirichlet Allocation](https://www.di.ens.fr/~fbach/mdhnips2010.pdf) provides more insights on the theoretical basis of the algorithm.
