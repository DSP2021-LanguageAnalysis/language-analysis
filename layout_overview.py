    ...
    html.Div(children=[
                html.Div(
                    ...
                    children=[
                        ...
                        Students: Arthur Hughes, Hilma Holappa, Miia Rämö, Mikko Lipsanen, Pyörni Vartiainen
                        
                        This application is licensed under the [MIT license](https://github.com/DSP2021-LanguageAnalysis/language-analysis/blob/main/LICENSE)
                            ''')
                        ])
